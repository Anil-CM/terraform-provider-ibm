...
func Provider() terraform.ResourceProvider {
	return &schema.Provider{
		...
		DataSourcesMap: map[string]*schema.Resource{
			...
			"ibm_container_vpc_worker_volume_attachment": dataSourceIBMContainerVpcWorkerVolumeAttachment(),
		...
		ResourcesMap: map[string]*schema.Resource{
			...
			"ibm_container_vpc_worker_volume_attachment":         resourceIBMContainerVpcWorkerVolumeAttachment(),
